...
plt.text(0, 170, ('shape: ' + str(left_img.shape)))
plt.imshow(left_img, cmap="gray")

plt.subplot2grid((1, 3), (0, 1));
plt.axis('off')
plt.title('center camera')
plt.text(0, 170, ('shape: ' + str(center_img.shape)))
plt.imshow(center_img, cmap="gray")

plt.subplot2grid((1, 3), (0, 2));
plt.axis('off')
plt.title('right camera')
plt.text(0, 170, ('shape: ' + str(right_img.shape)))
...
print("----------\nVerify Totals: {} should equal {} ".format((n_train+n_valid), len(udacity_norm)))
