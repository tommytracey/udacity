...
# ### 4.7 | Integrate all transformations into single function
...
## Create and reset the model  ** V1 - NVIDIA ** RE-TRAIN WITH TRACK 2 WEIGHTS ** 
...
model.load_weights('models/checkpoints/model_v48_e04_0.041.h5')
