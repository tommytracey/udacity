...
# keep_prob = 1.0  # used for GRAYSCALE image model
keep_prob = 0.5  # used for AUGMENTED image model
...
# Creates convolutional layer for GRAYSCALE model
...
# Sanity check: Re-calculate accuracy on test set using latest AUGMENTED model
