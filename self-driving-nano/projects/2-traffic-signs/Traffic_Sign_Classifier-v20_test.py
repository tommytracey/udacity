...
# data_pd_sorted = data_pd.sort_values(['Count'],ascending=[0]).reset_index()
...
#             plt.text(topK_pred[1][0][i][i_label]+.02,6-i_label-.25, "[{}]  {}".format(class_id, sign_name));
